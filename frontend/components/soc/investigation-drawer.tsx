  ...
  return (
    <>
      <Button variant="outline" size="sm" onClick={() => setOpen(true)}>
        <ShieldAlert data-icon="inline-start" /> Investigate
      </Button>
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetContent className="w-full overflow-y-auto sm:max-w-xl">
          <SheetHeader>
            ...
            <SheetDescription>
              Evidence-first triage surface for the active tenant.
            </SheetDescription>
          </SheetHeader>
          <div className="flex flex-col gap-4 p-5">
            <div className="flex items-center justify-between rounded-md border border-border bg-muted/20 p-3">
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  {alertId
                    ? 'Alert context is attached to this workspace.'
                    : 'Open an event or alert to populate evidence.'}
                </p>
              </div>
            ...
            <section className="rounded-md border border-border bg-card p-4">
              ...
              <p className="mt-3 text-sm leading-6 text-muted-foreground">
                Correlated event context, affected entities, and analyst notes
                will appear here from the authenticated API.
              </p>
            </section>
            <section className="rounded-md border border-border bg-card p-4">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                <Button
                  ...
                  disabled={!alertId || creating || created}
                >
                  {creating
                    ? 'Opening…'
                    : created
                ...
                <Button variant="ghost" size="sm">
                  <ExternalLink data-icon="inline-start" /> Open full record
                </Button>
              </div>
              {error && (
