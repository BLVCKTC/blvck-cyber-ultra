...
const responses: Record<string, string> = {
  ...
  'What should I fix first?':
    'Priority order: (1) Patch CVE-2024-3094 on the VPN concentrator — it is a critical backdoor with a public exploit. (2) Encrypt the 3 unencrypted data volumes flagged in Health Monitoring. (3) Remediate the MOVEit SQL injection on your banking database. Doing (1) and (2) alone should raise your security score by about 9 points.',
...
export function AIAssistant({
  ...
  const [messages, setMessages] = useState<Msg[]>([
    {
      role: 'ai',
      text: `Hi Amara — I'm your AI Security Analyst. I'm monitoring tenant ${tenantId} in real time. Ask me anything about your threats, vulnerabilities, or posture.`,
    },
  ])
  ...
  const send = (text: string) => {
    ...
    setTimeout(() => {
      setMessages((current) => [
        ...
        {
          role: 'ai',
          text: responses[question] ?? defaultReply,
        },
      ])
