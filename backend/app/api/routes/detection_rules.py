...
@router.get(
    ...
    dependencies=[Depends(require_permission("detection_rules.view"))],
)
def list_rules(
...
@router.post(
    ...
    dependencies=[Depends(require_permission("detection_rules.create"))],
)
def create(
...
@router.patch(
    "/{rule_id}",
    response_model=DetectionRuleRead,
    dependencies=[Depends(require_permission("detection_rules.update"))],
)
def update(
    rule_id: UUID,
...
@router.post(
    "/{rule_id}/transition",
    response_model=DetectionRuleRead,
    dependencies=[Depends(require_permission("detection_rules.transition"))],
)
def transition(
    rule_id: UUID,
...
@router.delete(
    ...
    dependencies=[Depends(require_permission("detection_rules.delete"))],
)
def remove(
    rule_id: UUID,
    membership: Membership = Depends(get_active_membership),
